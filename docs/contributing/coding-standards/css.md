...
You can run the linter in gulp: `gulp scss:stylelint` or check linting directly in [Sublime Text](https://github.com/SublimeLinter/SublimeLinter-stylelint), [Atom](https://atom.io/packages/linter-stylelint) or other [IDE's](https://stylelint.io/user-guide/integrations/editor)
...
More write up on [supported rules](https://github.com/stylelint/stylelint/blob/master/docs/user-guide/configure.md#rules).
